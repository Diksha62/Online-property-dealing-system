  ...
  <div class="content">
    <div class="innercontent">
      ...
      <table width="100%" height="249" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td height="28"><span class="style8">My Real Estate Limited,</span></td>
        </tr>
        <tr>
          <td height="28"><span class="style8">Near My Collage,</span></td>
        </tr>
        <tr>
          <td height="27"><span class="style8">MyCity(000000)</span></td>
        </tr>
        <tr>
          <td height="30"><span class="style8">Mobile:0001000100</span></td>
        </tr>
        <tr>
          <td height="29"><span class="style8">Email:info@myestate.com</span></td>
        </tr>
        <tr>
